...
class ContentTableMap extends TableMap
{
     ...
     */
    const COL_PAGE_NAME = 'content.page_name';

    /**
     * the column name for the content field
     */
    const COL_CONTENT = 'content.content';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'PageName', 'Content', ),
        self::TYPE_CAMELNAME     => array('id', 'pageName', 'content', ),
        self::TYPE_COLNAME       => array(ContentTableMap::COL_ID, ContentTableMap::COL_PAGE_NAME, ContentTableMap::COL_CONTENT, ),
        self::TYPE_FIELDNAME     => array('id', 'page_name', 'content', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'PageName' => 1, 'Content' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'pageName' => 1, 'content' => 2, ),
        self::TYPE_COLNAME       => array(ContentTableMap::COL_ID => 0, ContentTableMap::COL_PAGE_NAME => 1, ContentTableMap::COL_CONTENT => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'page_name' => 1, 'content' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('page_name', 'PageName', 'VARCHAR', true, 255, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContentTableMap::COL_PAGE_NAME);
            $criteria->addSelectColumn(ContentTableMap::COL_CONTENT);
        } else {
