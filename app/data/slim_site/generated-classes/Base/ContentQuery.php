 ...
 * @method     ChildContentQuery orderByPageName($order = Criteria::ASC) Order by the page_name column
 * @method     ChildContentQuery orderByContent($order = Criteria::ASC) Order by the content column
 *
 * @method     ChildContentQuery groupById() Group by the id column
 * @method     ChildContentQuery groupByPageName() Group by the page_name column
 * @method     ChildContentQuery groupByContent() Group by the content column
 *
 ...
 * @method     ChildContent findOneByPageName(string $page_name) Return the first ChildContent filtered by the page_name column
 * @method     ChildContent findOneByContent(string $content) Return the first ChildContent filtered by the content column *
 ...
 * @method     ChildContent requireOneByPageName(string $page_name) Return the first ChildContent filtered by the page_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildContent requireOneByContent(string $content) Return the first ChildContent filtered by the content column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildContent[]|ObjectCollection findByPageName(string $page_name) Return ChildContent objects filtered by the page_name column
 * @method     ChildContent[]|ObjectCollection findByContent(string $content) Return ChildContent objects filtered by the content column
...
abstract class ContentQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'slim_site', $modelName = '\\Content', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ContentTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, page_name, content FROM content WHERE id = :p0';
        try {
     ...
     * $query->filterByPageName('%fooValue%'); // WHERE page_name LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByPageName($pageName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContentTableMap::COL_PAGE_NAME, $pageName, $comparison);
    }
    ...
    public function filterByContent($content = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContentTableMap::COL_CONTENT, $content, $comparison);
    }
